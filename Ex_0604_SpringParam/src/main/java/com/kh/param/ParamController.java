...
public class ParamController {
	...
	// send1() 처리
	@RequestMapping("/insert1.do") // 파라미터를 받아오는 경우 
	//그 값을 받는 변수의 이름을 파라미터의 name명과 동일하게 맞춰야 한다.
	public String insert1( Model model, String name, int age, String pwd ) {
	// insert1.do?name=홍길동&age=20&pwd=1111
	//name, age, tel 변수로 같은 이름의 파라미터 값이 자동으로 저장된다.
	...
	// insert1.do?name=홍길동&age=20&pwd=1111
	// 파라미터로 넘어온 값들이 vo의 속성이 일치하는 변수에 자동으로 저장된다.
		model.addAttribute("vo", vo);
